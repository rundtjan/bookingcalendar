...
var buttonText =
  (activeYear + 1).toString() + "-" + (activeYear + 2).toString();
topMenu.innerHTML =
  '<div id="logo"><b>Lakanet 2.0</b> - förra läsåret</div><button type="button" id="showLastYear" onclick="showNextYear()">' +
  buttonText +
...
function makeBookings(booking) {
  ...
  clicker.setAttribute(
    "title",
    "test" /*booking.header + " " + booking.info + " " + booking.timestring*/
  );
